...
# github: https://github.com/ebojacky/console-chatbox-using-openai-and-langchain
...
chain = ConversationalRetrievalChain.from_llm(llm=ChatOpenAI(temperature=0.0, model_name='text-davinci-003', openai_api_key=constants.APIKEY), retriever=vectors.as_retriever())
history = []
